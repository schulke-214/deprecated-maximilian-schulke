...
export default class DeviceDetectionService {
	static data = new Parser().getResult();

	static get browser() {
		return {
			...this.data.browser,
			is: {
				ie: /IE/i.test(this.data.browser.name),
				chrome: /Chrome/i.test(this.data.browser.name),
				firefox: /Firefox/i.test(this.data.browser.name),
				safari: /Safari/i.test(this.data.browser.name),
				mobileSafari: /Mobile\sSafari/i.test(this.data.browser.name),
				opera: /Opera/i.test(this.data.browser.name)
			}
		};
	}
	...
	static get os() {
		return {
			...this.data.os,
			is: {
				windows: /Windows/i.test(this.os.name),
				mac: /Mac/i.test(this.os.name),
				linux: /Linux/i.test(this.os.name),
				ubuntu: /Ubuntu/i.test(this.os.name)
			}
		};
	}
